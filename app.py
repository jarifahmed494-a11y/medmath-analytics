...
# Navigation
tab1, tab2, tab3 = st.tabs(["1. CT Scan (Radon Transform)", "2. MRI (2D Fourier Transform)", "3. Ultrasound (Pulse-Echo)"])
...
with tab1:
    ...
    with col1:
        num_angles = st.slider("Number of X-Ray Projection Angles:", min_value=4, max_value=180, value=30, step=2)
        st.latex(r"Ax = b")
